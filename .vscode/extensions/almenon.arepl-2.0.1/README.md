...
Open a python file and click on the cat ![cat](https://github.com/almenon/arepl-vscode/raw/master/./media/happy_cat_24.png)  in the top bar to the right to open AREPL. You can click the cat again to close.
